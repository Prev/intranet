...
<?php Context::getInstance()->addHeaderFile('/modules/index/template/stylesheet.css', -1, 'head', NULL,NULL); ?><div id="welcome" class="clearfix"><div class="fl"><img src="http://127.0.0.1/intranet/modules/index/template/img/circle.png" width="450" height="250"></div><div id="welcome-text" class="fl"><div id="welcome-title"><?php echo fetchLocale(array(
			...
			)); ?></div></div></div><div><?php var_dump2($__attr->user); ?></div><div><?php if($__attr->loggedin) { ?><a href="http://127.0.0.1/intranet/?module=login&action=procLogout"><?php echo fetchLocale(array( 'en'=>'Sign out', 'kr'=>'로그아웃')); ?></a><?php } ?><?php if(!$__attr->loggedin) { ?><a href="<?php echo LOGIN_URL ?>"><?php echo fetchLocale(array( 'en'=>'Sign in', 'kr'=>'로그인')); ?></a><?php } ?></div>