...
<?php
	...
	class BoardCGIModel extends BoardModel {
		...
		public function insertNewArtile($boardId, $title, $content, $isSecret, $isNotice, $allowComment, $allowReply, $parentNo=NULL, $category=NULL) {
			$record = DBHandler::for_table('article')->create();
			$record->set(array(
				'board_id' => $boardId,
				'title' => $title,
		...
		public function updateArticle($articleData, $boardId, $title, $content, $isSecret, $isNotice, $allowComment, $allowReply, $category=NULL) {
			$articleData->set(array(
				'board_id' => $boardId,
				'title' => $title,
				'content' => $content,
