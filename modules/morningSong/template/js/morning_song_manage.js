...
function confirmSelectSong(songId) {
...
function selectSong() {
	...
	location.href = getUrl("morningsong", "procSelectSong", "song_id="+selectingSongId+"&dormitory_type=" + dormitoryType);
}


function cancleSelectedSong(dormitoryType) {
	location.href = getUrl("morningsong", "procCancleSelectedSong", "dormitory_type=" + dormitoryType);
}